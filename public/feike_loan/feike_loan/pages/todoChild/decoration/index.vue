...
<script>
	...
	export default {
		...
		async onLoad() {
			...
			// this.token = this.getQueryString("tempToken") 
			// this.refreshToken = this.getQueryString("refreshToken") 
			// this.UserInfo = this.getQueryString("UserInfo") 
			// this.isLogin = this.getQueryString("isLogin")  //是否暂停
			...
			// setStorage('userInfo',JSON.parse(this.dataL.UserInfo) )
